...
import {Label, FieldError, Description} from '../TextField/TextField';
import {AccessibleIcon} from '../accessible-icon';
import {Avatar} from '../Avatar';
import {Left, Right, Justified, Canada, Mexico, US} from '../icons';
...
export const WithDescription = () => {
    return (
        <Select placeholder="Select status&hellip;">
            <Label>Project status</Label>
            <Description>This will be visible to clients involved in the project.</Description>
            <SelectButton />
            <SelectPopover>
                <SelectListBox>
                    <SelectListItem id="1">Backlog</SelectListItem>
                ...
                <SelectListBox>
                    <SelectListItem id="1" textValue="Backlog">
                        ...
                        <SelectListItemDescription className="block w-full">
                            A backlog is a list of tasks waiting to be prioritized and completed.
                        </SelectListItemDescription>
                    </SelectListItem>
                    <SelectListItem id="2">
...
export const WithControlledSelect = () => {
    ...
    return (
        <Select placeholder="Select status&hellip;" selectedKey={statusId} onSelectionChange={setStatusId}>
            <Label>Project status</Label>
            <Description>This will be visible to clients involved in the project.</Description>
            <SelectButton />
                    ...
                    {user => {
                        return (
                            <SelectListItem textValue={user.name}>
                                <Avatar className="rounded-full" src={user.avatar} alt={user.name} />
                    ...
                    {user => {
                        return (
                            <SelectListItem textValue={user.name}>
                                ...
                                <SelectListItemLabel className="">{user.name}</SelectListItemLabel>
                                <SelectListItemDescription>{user.description}</SelectListItemDescription>
                            </SelectListItem>
                        );
                    }}
                </SelectListBox>
...
export const WithSecondaryText = () => {
    return (
        <Select placeholder="Assign to" defaultSelectedKey="1" className="w-full sm:min-w-72">
            <Label>Assignee</Label>
            <SelectButton />
            <SelectPopover>
                <SelectListBox items={users}>
...
CustomWidth.parameters = {
    docs: {
        description: {
            story: 'Use `className="min-w-*"`on the `SelectField` component to set select field width.',
        },
    },
};
...
function StatusIcon({className}: {className: string}) {
    return <span data-ui="icon" className={`size-3 rounded-full border border-solid border-white ${className}`} />;
}
