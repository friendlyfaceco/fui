...
export function Avatar({colorless = false, className, children, src, alt}: AvatarProps) {
...
function InitialAvatar({alt, id, colorless}: {alt: string; id: string; colorless: boolean}) {
...
export const AvatarBadge = ({'aria-label': ariaLabel, badge, ...props}: AvatarBadgeProps) => {
