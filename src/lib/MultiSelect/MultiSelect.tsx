...
import type {ComboBoxProps as RACComboBoxProps, Key, ListBoxItemProps, GroupProps} from 'react-aria-components';
import {ComboBox, composeRenderProps, LabelContext, Group} from 'react-aria-components';
import type {ListData} from 'react-stately';
import {useListData} from 'react-stately';
import {useFilter} from 'react-aria';
import {twMerge} from 'tailwind-merge';

import {DescriptionProvider, LabeledGroup, Input, DescriptionContext} from '../TextField/TextField';
import {ListBox, ListBoxItem} from '../ListBox';
import {Button} from '../Button';
import {TagGroup, TagList} from '../tagGroup2';
    ...
    return (
        <ListBoxItem
            ...
            className={composeRenderProps(props.className, (className, {isFocused}) => {
                return twMerge([
                    'rounded-lg p-1.5 text-base/6 outline-0 focus-visible:outline-0 dark:text-white sm:text-sm/6',
