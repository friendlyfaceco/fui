...
import {MultiSelect, MultiSelectField, MultiSelectItem} from './MultiSelect';
    ...
    return (
        <Form
            ...
            <MultiSelectField>
                    ...
                    tag={item => {
                        return (
                            <Tag textValue={item.textValue}>
                                <Avatar src={item.src} alt={item.userName} className="size-4 rounded-full" />
                                {item.textValue}
                            </Tag>
                        );
                    }}
                ...
                {isInvalid && <Text className="text-destructive">Please select an item in the list.</Text>}
            </MultiSelectField>
