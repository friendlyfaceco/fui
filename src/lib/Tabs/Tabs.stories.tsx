...
import {Strong} from '../Text/Text';
import {NativeSelectField, NativeSelect} from '../NativeSelect';
    ...
    return (
        <div className="p-4 sm:p-12">
            ...
            <Tabs selectedKey={tab} onSelectionChange={setTab}>
                <TabList className="hidden sm:flex" aria-label="Navigation" items={tabs}>
                    {item => {
...
TabsOnMobile.parameters = {
    docs: {
        description: {
            story: 'You can scroll tablist on mobile. If this is not what you want, you can show a selector on mobile. Please resize the screen to test.',
        },
    },
};
