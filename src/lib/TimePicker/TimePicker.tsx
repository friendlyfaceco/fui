...
export function TimePicker({intervalInMinute}: {intervalInMinute: 15 | 30}): TimeOption[] {
...
export function getRoundMinute({intervalInMinute, minute}: {intervalInMinute: number; minute: number}) {
