...
AllowsEmptyCollection.parameters = {
    docs: {
        description: {
            story: 'Whether the combo box allows the menu to be open when the collection is empty.',
        },
    },
};
            ...
            <ComboBoxPopover>
                <ComboBoxListBox>
                    <ComboBoxListItem textValue="Add to queue">
                        ...
                        <ComboBoxListItemDescription>Add to current watch queue.</ComboBoxListItemDescription>
                    </ComboBoxListItem>
                    <ComboBoxListItem textValue="Add review">
                        <ComboBoxListItemLabel>Add review</ComboBoxListItemLabel>
                        <ComboBoxListItemDescription>Post a review for the episode.</ComboBoxListItemDescription>
                    </ComboBoxListItem>
                    ...
                    <ComboBoxListItem textValue="Report">
                        ...
                        <ComboBoxListItemDescription>Report an issue/violation.</ComboBoxListItemDescription>
                    </ComboBoxListItem>
                </ComboBoxListBox>
            </ComboBoxPopover>
        </ComboBox>
