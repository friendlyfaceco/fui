...
export const BasicExample = () => {
    return (
        <Text>
            <Strong>React Aria </Strong> is a library of unstyled React components and hooks that helps you build{' '}
            <Strong>accessible, high quality UI components</Strong> for your application or design system. It provides
            components for common UI patterns, with{' '}
            <TextLink href="https://react-spectrum.adobe.com/react-aria/accessibility.html">accessibility</TextLink>,{' '}
            <TextLink href="https://react-spectrum.adobe.com/react-aria/internationalization.html">
                internationalization
            </TextLink>
            , <TextLink href="https://react-spectrum.adobe.com/react-aria/interactions.html">interactions</TextLink>,
