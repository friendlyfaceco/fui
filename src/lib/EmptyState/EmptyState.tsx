...
export function EmptyState({className, ...props}: JSX.IntrinsicElements['div']) {
    return (
        <div
            {...props}
            className={twMerge(
...
export function EmptyStateIcon({className, children, ...props}: JSX.IntrinsicElements['div']) {
    return (
        <div
            {...props}
            className={twMerge(
...
export function EmptyStateHeading({className, level = 2, ...props}: HeadingProps) {
    return <Heading {...props} level={level} className={twMerge('text-balance', className)} />;
}
...
export function EmptyStateActions({className, ...props}: JSX.IntrinsicElements['div']) {
    return (
        <div {...props} className={twMerge('mt-3 flex flex-col items-center justify-center gap-4 p-2', className)} />
    );
}
